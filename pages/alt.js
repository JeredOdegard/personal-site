...
export default function Alt() {
  return (
    <div className="antialiased">
      ...
      <div className="relative overflow-hidden h-128">
        ...
        <div className="relative max-w-screen-xl mx-auto">
          ...
          <div className="flex justify-between pt-6">
            ...
            {/* Contact */}
            <a href="/contact">
              <button className="hidden md:flex px-4 py-2 bg-white bg-opacity-30 font-medium tracking-wide text-white hover:bg-opacity-40 transform transition hover:scale-105 text-sm rounded-full">Contact</button>
            </a>
            {/* Contact - End */}
      ...
      <div className="max-w-screen-xl mx-auto -mt-96 md:-mt-72 relative z-10">
      ...
      <div className="grid grid-cols-12 gap-x-2 gap-y-4 md:gap-y-10 md:gap-x-10 max-w-screen-xl mx-auto mt-10 mb-20 border-l border-r border-dashed border-gray-300">
        <div className="col-span-full md:col-span-3 flex justify-center items-center">
      ...
      <div className="w-full py-24 bg-white mb-32">
        <div className="grid grid-cols-12 gap-x-2 gap-y-4 md:gap-y-10 md:gap-x-10 max-w-screen-xl mx-auto">
            ...
            <div>
              ...
              <div className="mt-14 grid grid-cols-2 gap-x-10">
                <div className="col-span-1">
                  <div className="font-medium text-black text-sm mb-2">A plan that works for you</div>
                ...
                <div className="col-span-1">
                  <div className="font-medium text-black text-sm mb-2">Breakthrough insight</div>
          ...
          <div className="col-span-4">
            <img className="w-full bg-transparent rounded-sm" src="clip_bw.png" />
          </div>
        </div>
      </div>
      ...
      <div className="w-full pt-16 bg-white mb-32">
        <div className="grid grid-cols-12 gap-x-2 gap-y-4 md:gap-y-10 md:gap-x-10 max-w-screen-xl mx-auto">
          ...
          <div className="col-span-3">
            <div className="font-medium text-black text-sm mb-2">Hire the best</div>
            <p className="text-black text-opacity-70 text-sm mb-2">Coaching will double your self-awareness. After our conversations, you'll leave with clarity and motivation.</p>
            <a className="text-sm text-blue-600 font-medium" href="#">Get notified</a>
          </div>
          <div className="col-span-3">
          ...
          <div className="col-span-3">
            <div className="font-medium text-black text-sm mb-2">Scale your influence</div>
            <p className="text-black text-opacity-70 text-sm mb-2">Coaching will double your self-awareness. After our conversations, you'll leave with clarity and motivation.</p>
            <a className="text-sm text-blue-600 font-medium" href="#">Get notified</a>
          </div>
        </div>
