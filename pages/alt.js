...
function Blog() {
  return (
    <div className="min-w-sm antialiased">
      ...
      <div className="hidden w-full h-full absolute z-50 bg-white">Hello</div>

      {/* Background Shape */}
      <div className="absolute z-0 w-full">
        <div className="bg-yellow-50 h-96 sm:h-80 md:h-80 lg:h-48 xl:h-0"></div>
      ...
      <div className="px-6 lg:px-24 pt-6 pb-4 z-10 relative">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex items-center">
            ...
            <nav className="hidden md:flex gap-x-8 ml-24 text-sm lg:text-base">
              ...
              <a className="font-medium text-gray-500 hover:text-gray-800" href="/blog">Blog</a>
          ...
          {/* Hamburger */}
          <button className="h-9 w-9 mr-3 md:hidden fill-current text-gray-900" onClick={toggleNav}>
        ...
        {/* Hero */}
        <div className="mt-32 mb-24 sm:mb-48 lg:mb-52 text-center mx-auto max-w-lg md:max-w-none">
          ...
          <p className="text-gray-500 text-xl md:text-2xl max-w-screen-lg mt-4 mx-auto">My purpose is to help create more authentic and capable leaders.</p>
          <a href="/about">
        ...
        {/* Coach Card */}
        <div className="w-full p-16 md:py-32 flex items-center mt-10 bg-white mb-16 rounded-xl shadow-xl border">
        ...
        {/* Podcast Card */}
        <div className="w-full p-16 md:py-32 flex items-center bg-yellow-50 mb-10 rounded-xl">
