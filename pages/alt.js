...
function Blog() {
  return (
    <div className="min-w-sm antialiased">
      ...
      <div className="p-24 pt-8 pb-4">

        <div className="flex justify-between">
          <nav className="text-gray-400 flex justify-between gap-x-8 font-medium">
            <div className="h-20 w-16 bg-gray-900 flex items-center justify-center fill-current text-white relative -top-8 rounded-b">
            ...
            <a className="hover:text-gray-200" href="#">Coaching</a>
            <a className="hover:text-gray-200" href="#">Podcast</a>
            <a className="hover:text-gray-200" href="#">Blog</a>
            <a className="hover:text-gray-200" href="#">About</a>
          </nav>
          <button className="h-10 px-4 py-2 bg-yellow-100 font-bold text-yellow-600 rounded -mt-2 hover:bg-yellow-200">
          Contact
          </button>
        </div>
          ...
          <section className="grid grid-cols-12 max-w-screen-xl lg:gap-x-20 mx-auto items-center">
            <div className="col-span-full xl:col-span-8">
              ...
              <p className="text-lg sm:text-2xl font-medium sm:leading-10 mb-6 text-gray-500 max-w-screen">I help high performing professionals and executives at companies like <span className="font-bold text-gray-700">Amazon</span>,  <span className="font-bold text-gray-700">Facebook</span>, and <span className="font-bold text-gray-700">Microsoft</span> achieve their goals. I'm confident I can accelerate you towards where you want to be.</p>
                <a href="#">
                  <button className="px-8 py-4 bg-yellow-100 text-lg font-bold text-yellow-600 rounded mt-2 lg:mt-4 hover:bg-yellow-200">What is coaching?</button>
                </a>
            </div>
