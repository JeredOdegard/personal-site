  ...
  return (
    <div className="pt-48">
      <main className="mb-48">
        ...
        <div className="max-w-screen-xl mx-auto relative z-10 text-center mt-24">
      ...
      <div className="grid grid-cols-12 gap-x-10 max-w-screen-xl mx-auto relative z-10 pb-24">
        <div className="col-span-6">
          <div className="bg-gradient-to-br from-green-200 to-blue-500 w-full rounded-xl shadow-medium p-16">
            <h3 className="text-white text-6xl font-black leading-none mb-6">Fast-track your growth.</h3>
        ...
        <div className="col-span-6">
          <div className="bg-black w-full rounded-xl shadow-medium p-16">
            <h3 className="text-white text-6xl font-black leading-none mb-6">Experts say.</h3>
