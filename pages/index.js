    ...
    <div id="main" className="antialiased">
      ...
      <div id="mobileMenu" className="hidden w-full h-full fixed z-50 bg-white p-6 overflow-y-auto">
        ...
        <nav className="space-y-4 lg:space-y-10 text-4xl lg:text-6xl text-gray-800 font-serif">
          <a className="block border-b border-gray-200 p-4 rounded-md hover:bg-yellow-100 hover:border-yellow-100 hover:text-yellow-800" href="/">Home</a>
          <a className="block border-b border-gray-200 p-4 rounded-md hover:bg-yellow-100 hover:border-yellow-100 hover:text-yellow-800" href="/coaching">Coaching</a>
          <a className="block border-b border-gray-200 p-4 rounded-md hover:bg-yellow-100 hover:border-yellow-100 hover:text-yellow-800" href="/podcast">Podcast</a>
          <a className="block border-b border-gray-200 p-4 rounded-md hover:bg-yellow-100 hover:border-yellow-100 hover:text-yellow-800" href="/about">About</a>
          <a className="block p-4 rounded-md hover:bg-yellow-100 hover:text-yellow-800" href="/about">Contact</a>
        </nav>
      </div>
      {/* Mobile Nav - End */}
